...
public abstract class Enemy extends com.logicmaster63.tdgalaxy.entity.AttackingEntity {
    ...
    public Enemy(Vector3 position, double speeed, int hp, int range, float coolDown, int types, ModelInstance instance, btCollisionShape shape, btCollisionWorld world, IntMap<com.logicmaster63.tdgalaxy.entity.Entity> entities, String attackAnimation, Vector3 attackOffset, boolean isTemplate, List<Vector3> path) {
