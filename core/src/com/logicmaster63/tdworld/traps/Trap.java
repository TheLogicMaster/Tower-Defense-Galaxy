...
public abstract class Trap extends Object{
    ...
    public Trap(Vector3 pos, int hp, int health, int types, ModelInstance instance, btCollisionShape shape, int effects, btCollisionWorld world, Map<Integer, Object> objects) {
