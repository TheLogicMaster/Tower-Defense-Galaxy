...
public class Basic extends Enemy{
    ...
    public Basic(Vector3 position, double speeed, int hp, int coolDown, int types, ModelInstance instance, btCollisionWorld world, HashMap<Integer, Object> objects) {
        this(position, speeed, hp, hp, coolDown, types, instance, 0, world, objects);
    }

    public Basic(Vector3 pos, double speeed, int hp, int health, int coolDown, int types, ModelInstance instance, int effects, btCollisionWorld world, HashMap<Integer, Object> objects) {
