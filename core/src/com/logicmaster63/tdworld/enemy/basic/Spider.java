...
public class Spider extends Enemy {
    ...
    public Spider(Vector3 position, double speeed, int hp, int coolDown, int types, ModelInstance instance, btCollisionShape shape) {
        super(position, speeed, hp, coolDown, types, instance, shape);
    }

    public Spider(Vector3 pos, double speeed, int hp, int health, int coolDown, int types, ModelInstance instance, btCollisionShape shape, int effects) {
