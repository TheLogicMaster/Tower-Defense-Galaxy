...
public class ProjectileTower extends Tower{
    ...
    public ProjectileTower(Vector3 pos, int hp, int range, float coolDown, int types, ModelInstance instance, btCollisionShape shape, btCollisionWorld world, Map<Integer, Object> objects, String attackAnimation, Projectile projectile, Vector3 attackOffset, boolean isTemplate) {
        this(pos, hp, hp, range, coolDown, types, instance, shape, 0, world, objects, attackAnimation, projectile, attackOffset, isTemplate);
    }

    public ProjectileTower(Vector3 pos, int hp, int health, int range, float coolDown, int types, ModelInstance instance, btCollisionShape shape, int effects, btCollisionWorld world, Map<Integer, Object> objects, String attackAnimation, Projectile projectile, Vector3 attackOffset, boolean isTemplate) {
