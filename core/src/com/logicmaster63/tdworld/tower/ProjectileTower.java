...
public class ProjectileTower extends Tower{
    ...
    public ProjectileTower(Vector3 pos, int hp, int range, float coolDown, int types, ModelInstance instance, btCollisionShape shape, btCollisionWorld world, IntMap<Entity> entities, String attackAnimation, Projectile projectile, Vector3 attackOffset, boolean isTemplate) {
        this(pos, hp, hp, range, coolDown, types, instance, shape, 0, world, entities, attackAnimation, projectile, attackOffset, isTemplate);
    }

    public ProjectileTower(Vector3 pos, int hp, int health, int range, float coolDown, int types, ModelInstance instance, btCollisionShape shape, int effects, btCollisionWorld world, IntMap<Entity> entities, String attackAnimation, Projectile projectile, Vector3 attackOffset, boolean isTemplate) {
