...
public class Bullet extends Projectile {
    ...
    public Bullet(Vector3 pos, Vector3 velocity, int hp, int health, int types, ModelInstance model, btCollisionShape shape, boolean isTower, btCollisionWorld world, HashMap<Integer, Object> objects) {
